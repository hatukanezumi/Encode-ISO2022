...
=head2 L<Encode::JISLegacy>
  ...
  159  jis-x-0212            JIS X 0212-1990 *
       jis-x-0212-ascii      JIS X 0212-1990 operable with ASCII
  ----------------------------------------------------------------
  * About compatible encodings not taking care of characters with
    combning marks, see Encode::JP.
...
=head3 L<Encode::JP>
  ...
  ----------------------------------------------------------------
  Note that GL mapping of jis0201-raw is broken.  Use iso-646-jp
  in Encode::ISOIRSingle.

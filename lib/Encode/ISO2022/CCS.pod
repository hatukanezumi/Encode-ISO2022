...
From view of Perl, a CCS is the L<Encode::Encoding> object with stateless and
fixed-length conversion over 94^n or 96^n code table.

"reg#" column in tables below indicates the number of registry in ISO
International Registry of Coded Character Sets [ISO-IR].

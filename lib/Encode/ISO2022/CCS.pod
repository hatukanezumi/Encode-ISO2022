...
Encode::ISO2022::CCS - coded character sets for ISO/IEC 2022 encoding scheme
...
"reg#" column indicates the number of registry in ISO international registry
of coded character sets [ISO-IR].

=head2 Built-in encodings

  reg# Name                  Description
  ----------------------------------------------------------------
    6  ascii                 ANSI X3.4-1986, equivalent to ISO646-IRV
   -   ascii-ctrl            ISO 6429 control characters (C0)
   -   c1-ctrl               ISO 6429 control characters (C1)
  ----------------------------------------------------------------

=head2 L<Encode::ISO2022::CCS::ISO8859>
...
=head2 L<Encode::ISO2022::CCS::JISLegacy>

  reg# Name                  Description
  ----------------------------------------------------------------
   14  jis0201-left          JIS X0201 Latin set, ISO646-JP
   13  jis0201-right         JIS X0201 katakana set
   42  jis0208-1978-raw      JIS C6226-1978, 1st rev. of JIS X0208
  ----------------------------------------------------------------
...
=head3 L<Encode::HanExtra>
  ...
  none cns11643-f            CNS 11643 plane 15 or 8
  ----------------------------------------------------------------

=head3 L<Encode::ISO2022::CCS::JISX0213>

  reg# Name                  Description
  ----------------------------------------------------------------
  228  jisx0213-2000-plane1  JIS X0213:2000 level 3 (plane 1)
       jisx0213-2000-plane1-ascii
       jisx0213-2000-plane1-jis
  233  jisx0213-plane1       JIS X0213:2004 level 3 (plane 1)
       jisx0213-plane1-ascii
       jisx0213-plane1-jis
  229  jisx0213-plane2       JIS X0213:2000/2004 level 4 (plane 2)
  ----------------------------------------------------------------
...
=head3 L<Encode::JP>
  ...
  reg# Name                  Description
  ----------------------------------------------------------------
   87  jis0208-raw           JIS X0208-1983, 2nd rev. of JIS X0208
  168      ditto             JIS X0208-1990
  159  jis0212-raw           JIS X0212-1990
  ----------------------------------------------------------------
...
[ISO-IR] International Register of Coded Character Sets to be Used with Escape

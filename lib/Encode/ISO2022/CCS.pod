...
This document lists encoding which may be used as coded character set
(CCS) for ISO/IEC 2022 character encoding scheme.
For more details about CCS see L<Encode::ISO2022>.
...
=head2 L<Encode::JISLegacy>
 ...
 (159) jis-x-0212-ascii      JIS X 0212-1990 operable with ASCII
  ----------------------------------------------------------------
...
About compatible encodings taking care of characters with combning marks,
see Encode::JISX0213.

=back

Note that GL mapping of jis0201-raw provided by this module is broken.
Use iso-646-jp provided by L<Encode::ISOIRSingle>.
